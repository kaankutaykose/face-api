...
app.get("/age_gender_recognition_emotion", (req, res) =>
  res.sendFile(path.join(viewsDir, "ageGenderRecognitionEmotion.html")),
);
app.get("/webcam_age_gender_recognition_emotion", (req, res) =>
  res.sendFile(path.join(viewsDir, "webcamAgeGenderRecognitionEmotion.html")),
);
